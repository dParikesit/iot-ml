...
def full_pipeline(image_url: str, log=True, debug=False):
    ...
    for license_plate in license_plates.boxes.data.tolist():
        ...
        xcar1, ycar1, xcar2, ycar2, score, class_id = get_car(license_plate, detections_)
        ...
        if class_id != -1:
            ...
            if license_plate_text is not None:
                if log:
                    ...
                    log_file.close()
                output.append((conv_class(class_id, yolo_model.names), format_license(license_plate_text)))
    return output

print(full_pipeline("input/motor2.jpg", debug=True))
